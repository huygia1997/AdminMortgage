sap.ui.define([
	...
	return BaseController.extend("sap.ui.demo.toolpageapp.controller.App", {
		...
		onItemSelect: function(oEvent) {
			...
			if ((sKey === "home" || sKey === "masterSettings" || sKey === "statistics" || sKey === "shopManager" || sKey === "userManager" ||
					sKey === "categoryManager" || sKey === "shopPending")) {
		...
		onUserNamePress: function(oEvent) {
			...
			var onLogout = function() {
				that.getGlobalModel().setProperty("/accountId", "");
				that.getGlobalModel().setProperty("/username", "");
				that.getGlobalModel().setProperty("/role", "");
				that.getGlobalModel().setProperty("/password", "");
				// remove localStorage
				localStorage.removeItem("username");
				localStorage.removeItem("uid");

				that.getRouter().navTo("loginView");
			};
